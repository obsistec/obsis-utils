...
function isCPF(value) {
  try {
    return (value == null ? void 0 : value.toString().replace(/[^0-9]/g, "").length) === 11;
  } catch {
    return false;
  }
}
function isCNPJ(value) {
  try {
    return (value == null ? void 0 : value.toString().replace(/[^0-9]/g, "").length) === 14;
  } catch {
    return false;
  }
}
function isEditFormByRouteName(routeName) {
  try {
    return routeName == null ? void 0 : routeName.toString().includes("-edit");
  } catch {
    return false;
  }
}
...
function addDateMask(date) {
  ...
  if ((maskedDate == null ? void 0 : maskedDate.length) < 3)
    return maskedDate;
  if ((maskedDate == null ? void 0 : maskedDate.length) < 5)
...
function removeDateMask(date) {
  ...
  if ((date == null ? void 0 : date.length) === 4)
    return `${date.slice(0, 4)}-`;
  if ((date == null ? void 0 : date.length) === 6)
...
function formatDateTime(date, hour) {
  try {
    if (date == null ? void 0 : date.includes("T")) {
      try {
...
function getHourInDate(date) {
  try {
    let hour = "";
    hour = (date == null ? void 0 : date.split("T")[1].substring(0, 5)) || "";
    return hour;
  } catch {
    return "";
  }
...
function formatLocality(ob_cidade) {
  if (!(ob_cidade == null ? void 0 : ob_cidade.nm_cidade) || !ob_cidade.ds_uf)
    return "";
  return `${ob_cidade.nm_cidade} / ${ob_cidade.ds_uf}`;
}
function formatLocalityLong(ob_cidade) {
  var _a, _b;
  if (!(ob_cidade == null ? void 0 : ob_cidade.nm_cidade) || !((_a = ob_cidade.cd_estado) == null ? void 0 : _a.nm_estado))
    return "";
  return `${ob_cidade.nm_cidade} / ${(_b = ob_cidade.cd_estado) == null ? void 0 : _b.nm_estado}`;
}
...
function formatCreditCard(value) {
  return (value == null ? void 0 : value.replace(/[^0-9]/, "")) || "";
}
...
function getUserName(firstName, lastName, full = true) {
  ...
  if (name === "undefined")
    return "";
  if (!full && (name == null ? void 0 : name.length) > 16)
    return name.split(" ")[0];
  return name;
}
...
function useFilter({ ignore } = { ignore: [] }) {
  ...
  ignore == null ? void 0 : ignore.push("pg");
  const hasFilters = vue.computed(() => Object.keys(route.query).filter((item) => !ignore.includes(item)).length);
  const hasAnyFilters = vue.computed(() => Object.keys(route.query).filter((item) => !["pg"].includes(item)).length);
...
function usePagination(params) {
  ...
  const pagination = vue.computed(() => (secondaryModule ? store.state[module][secondaryModule] : store.state[module])[params.field || "pagination"]);
...
exports.addDateMMAAAAMask = addDateMMAAAAMask;
exports.addDateMask = addDateMask;
exports.addHoursMask = addHoursMask;
exports.addMoneyMask = addMoneyMask;
exports.addUTC = addUTC;
exports.agendaCalendarTypes = agendaCalendarTypes;
exports.agendaTypeOptions = agendaTypeOptions;
exports.agendamentoStatus = agendamentoStatus;
exports.compareDates = compareDates;
exports.conselhos = conselhos;
exports.dayOfWeek = dayOfWeek;
exports.detectCardType = detectCardType;
exports.formatCPF = formatCPF;
exports.formatCPFToLGPD = formatCPFToLGPD;
exports.formatCreditCard = formatCreditCard;
exports.formatDate = formatDate;
exports.formatDateEn = formatDateEn;
exports.formatDateLong = formatDateLong;
exports.formatDateMMAAAA = formatDateMMAAAA;
exports.formatDateTime = formatDateTime;
exports.formatDateTimeEn = formatDateTimeEn;
exports.formatDateTimeLong = formatDateTimeLong;
exports.formatFileName = formatFileName;
exports.formatFullDateLong = formatFullDateLong;
exports.formatGender = formatGender;
exports.formatHours = formatHours;
exports.formatLocality = formatLocality;
exports.formatLocalityLong = formatLocalityLong;
exports.formatMoneyNumberToString = formatMoneyNumberToString;
exports.formatNumericDateLong = formatNumericDateLong;
exports.formatPhone = formatPhone;
exports.formatZipCode = formatZipCode;
exports.genderOptions = genderOptions;
exports.getAgendaCalendarTypes = getAgendaCalendarTypes;
exports.getAgendaTypeOptions = getAgendaTypeOptions;
exports.getAgendamentoStatus = getAgendamentoStatus;
exports.getHourInDate = getHourInDate;
exports.getUserName = getUserName;
exports.guideStatus = guideStatus;
exports.isCNPJ = isCNPJ;
exports.isCPF = isCPF;
exports.isEditFormByRouteName = isEditFormByRouteName;
exports.localeConfig = localeConfig;
exports.removeCNPJMask = removeCNPJMask;
exports.removeCPFMask = removeCPFMask;
exports.removeDateMMAAAAMask = removeDateMMAAAAMask;
exports.removeDateMask = removeDateMask;
exports.removeFormatZipCode = removeFormatZipCode;
exports.removeMoneyMask = removeMoneyMask;
exports.removeMoneyMaskAndConvert = removeMoneyMaskAndConvert;
exports.removePhoneMask = removePhoneMask;
exports.sexOptions = sexOptions;
exports.splitUserName = splitUserName;
